...
q = deg2rad([30,-30,35,-30,0]);                                                     % Create a vector of initial joint angles        
...
% point provided
otherPoint = [1 -2.260 1];

% adjust joint states
q = deg2rad([0, 40, -80, 0, 45, 0]);
T = p560.fkine(q);
