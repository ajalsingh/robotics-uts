...
%% Q2.2 Plot transform at (300, 550)
hold on;
...
for i = 1:forLoopIncrements
    % determine new transform after movement and rotation
    car1Tr = car1Tr * car1MoveTr * car1TurnTr;
    
    % delete previous transform (clear from screen)
